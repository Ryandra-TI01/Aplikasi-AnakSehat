        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td class="text-center">
                    @if ($dokter->icon === 'check')
                        <svg style="background-color: {{ $dokter->bgColor }}; color: white;" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
                            <path fill="currentColor" d="m9.55 18l-5.7-5.7l1.425-1.425L9.55 15.15l9.175-9.175L20.15 7.4z"/>
                        </svg>
                    @elseif ($dokter->icon === 'close')
                        <svg width="24" height="24" id="Layer_1" style="background-color: {{ $dokter->bgColor }}; color: white;" version="1.1" viewBox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    @else
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="24" height="24" xml:space="preserve">
                            <circle fill="{{ $dokter->bgColor }}" cx="256" cy="256" r="246"/>
