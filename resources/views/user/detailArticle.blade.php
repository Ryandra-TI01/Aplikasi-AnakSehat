...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card-body overflow-hidden" style="width: 100%; height: 300px;border-radius: 10px ">
      <img src="{{ $data->image ? asset('storage/' . $data->image) : 'https://images.unsplash.com/photo-1576089073624-b5751a8f4de9?q=80&w=1925&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' }}" 
